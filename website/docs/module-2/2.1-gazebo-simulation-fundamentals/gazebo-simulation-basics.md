...
Continue to [2.2 Robot Model Design & Integration](../2.2-robot-model-integration/robot-model-design-integration.md) to learn how to import and configure robot models in Gazebo.