...
# 2.1 Gazebo Simulation & Environment Setup
...
- **Readings**:
  - [Gazebo Simulation Basics](./gazebo-simulation-basics.md)
- **Videos**: [TBD - 2.1 lecture videos]
- **Assignments**:
  - [Simulation Lab Exercises](./simulation-lab-exercises.md)
...
Continue to [2.2 Robot Model Design & Integration](/docs/module-2/2.2-robot-model-integration/)

---

## Navigation

[← Module 2 Index](/docs/module-2/) | [2.2 Robot Model Design & Integration →](/docs/module-2/2.2-robot-model-integration/)
