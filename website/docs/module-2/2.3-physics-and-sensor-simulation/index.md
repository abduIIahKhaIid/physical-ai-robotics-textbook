...
# 2.3 Physics Engines & Sensor Modeling
...
- **Readings**:
  - [Physics Engine & Sensor Modeling Guide](./physics-engine-sensor-modeling.md)
- **Videos**: [TBD - 2.3 lecture videos]
- **Assignments**:
  - [Sensor Simulation Lab Exercises](./sensor-simulation-lab-exercises.md)
...
Continue to [2.4 ROS2-Gazebo Integration Framework](/docs/module-2/2.4-gazebo-ros2-integration/)

---

## Navigation

[← 2.2 Robot Model Design & Integration](/docs/module-2/2.2-robot-model-integration/) | [2.4 ROS2-Gazebo Integration Framework →](/docs/module-2/2.4-gazebo-ros2-integration/)
