...
After completing these exercises, continue to [2.4 ROS2-Gazebo Integration Framework](../2.4-gazebo-ros2-integration/index.md) to learn how to connect ROS2 nodes to Gazebo for hardware-in-the-loop testing.