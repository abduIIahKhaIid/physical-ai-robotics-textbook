...
After completing these exercises, continue to [Week 3: Physics and Sensor Simulation](../week-3/) to learn about configuring physics properties and sensor models for realistic simulation.